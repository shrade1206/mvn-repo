...
<div class="content">
    ...
    <tbody>
    <c:forEach var="i9s" items="${select}" varStatus="status">
    	  <tr>
            ...
            <td class="mid" style="vertical-align:middle;"><h4>${nameType[status.index] }</h4></td>
  ...
  <div class="container">
	  ...
	  <ul class="pagination"> 
	    ...
	    <button class="page-link" onclick="location.href='${pageContext.request.contextPath}/pages/i9s/${currentPage==1?1:currentPage-1}'">
		    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
			  <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"/>
			</svg>
	    </button></li>
		    <c:forEach	var="i" begin="1" end="${totalPage }">
		  	  <li class="page-item "><a class="page-link" href="${pageContext.request.contextPath}/pages/i9s/${i}">${i}</a></li>
		    </c:forEach>
	    <li class="page-item active">
	    <button class="page-link" onclick="location.href='${pageContext.request.contextPath}/pages/i9s/${currentPage==totalPage?totalPage:currentPage+1}'">
